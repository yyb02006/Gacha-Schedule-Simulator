        ...
        <div className="text-standard font-S-CoreDream-300 space-y-6">
          <div className="space-y-2">
            ...
            <div className="space-y-2 leading-7">
              ...
              <div>
                <span className="font-S-CoreDream-500 text-sky-500">모바일 환경</span>의 경우 최대
                가챠 횟수가 제한될 수 있으며, PC환경의 10% ~ 20% 성능을 기준으로 합니다.
              </div>
            </div>
          </div>
          <div className="space-y-2">
            <div className="font-S-CoreDream-500 flex gap-1 text-lg text-red-400">
              <div className="my-[4px] w-[5px] self-stretch bg-red-400" />
              배너 실패시 동작
            </div>
            <div className="space-y-2 leading-7">
              <div>
              ...
              <div>
                ...
                재화부족의 경우 이후 배너는 전부 실패할 수 있는 등 의미없는 데이터가 섞일 수 있으나
                현실에서는 재화가 부족해도 부족한 상태로 가챠일정을 진행해야하니 실제 행동에 더
                가까울 수 있습니다.
              </div>
            </div>
          </div>
