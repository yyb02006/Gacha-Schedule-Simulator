            ...
            <li className="space-y-2">
              ...
              <div className="font-S-CoreDream-400 mt-3 flex gap-x-6 gap-y-2 lg:mt-0">
                <div
                  className={cls(
                    rarityColor['sixth'].textColor,
                    'flex flex-initial flex-row items-center gap-x-2 gap-y-1',
                  )}
                >
        ...
        <section className="space-y-5 bg-[#303030] px-4 py-5 lg:px-6">
          ...
          <ol className="text-standard font-S-CoreDream-300 list-disc space-y-3 pl-4">
            ...
            <li className="mb-4 space-y-2">
              ...
              <div className="font-S-CoreDream-400 flex flex-wrap gap-2">
          ...
          <ol className="text-standard font-S-CoreDream-300 list-disc space-y-3 pl-4">
            ...
            <li className="leading-7">
              ...
              <p className="font-S-CoreDream-400 text-[13px] leading-5 text-red-400">
                ⚠ 획득하지 못한 픽업 오퍼레이터가 있을 시 해당 오퍼레이터로 확정되는 지, 획득 여부에
                상관 없이 150회 이후 둘 중 하나로 확정되는지에 대해서 확실하지 않습니다. 그러나 본
                시뮬레이션에서는 천장 시스템의 문맥상 위 내용으로 해석하고 있으며, PRTS 웹페이지
                로테이션 가챠 시뮬레이터 룰의 내용과 동일합니다.
              </p>
            </li>
          </ol>
        </section>
